        ...
        if (xhrPokemon.status === 200) {
          ...
          xhrEspecie.onload = function () {
            if (xhrEspecie.status === 200) {
              ...
              //tarjeta de los pokemones
              const tarjeta = document.createElement("div");
              tarjeta.className ="bg-white shadow-md rounded-xl text-center overflow-hidden";

              //imagen
              const imagen =document.createElement("img");
              imagen.src = pokemon.sprites.front_default;
              imagen.className ="w-32 h-32 mx-auto mt-5 bg-gray-100 rounded-full p-2";

              //cuerpo
              const cuerpo = document.createElement("div");
              cuerpo.className ="p-5";

              //nombre
              const nombre = document.createElement("h2");
              nombre.textContent =pokemon.name;
              nombre.className ="text-2xl font-bold capitalize";

              //informacion adicional opcional
              const verInformacion = document.createElement("p");
              verInformacion.textContent ="Ver mas >>";
              verInformacion.className = "text-blue-600 font-bold cursor-pointer mt-2";

              const informacion =document.createElement("div");
              informacion.className ="hidden mt-4";
              ...
              tituloEstadisticas.className = "font-bold text-lg mt-5";

              const estadisticas = document.createElement("div");
              estadisticas.className ="grid grid-cols-2 gap-3 mt-3";
              ...
              //agregar datos a la informacion opcional
              ...
              verInformacion.addEventListener("click",function () {
                  ...
                  if (informacion.classList.contains("hidden")) {
